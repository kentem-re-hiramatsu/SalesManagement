...
namespace SalesManagementTest.ModelTest
{
    ...
    public class PurchaseTest
    {
        ...
        public void PurchaseConstructorTest()
        {
            ...
            var purchase = new Purchase(ringo, 100, 101, 20, new DateTime(2024, 06, 21));
            ...
            Assert.AreEqual(101, purchase.SalePrice);
            ...
            Assert.ThrowsException<Exception>(() => new Purchase(ringo, 100, 100, 20, new DateTime(2024, 06, 21)));
        }
    }
}